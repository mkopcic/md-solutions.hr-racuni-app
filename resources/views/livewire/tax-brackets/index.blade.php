<div>
    ...
    <!-- Desktop tablica -->
    <div class="hidden xl:block overflow-x-auto rounded-lg border border-zinc-200 bg-white dark:border-zinc-700 dark:bg-zinc-900">
    ...
    <div class="xl:hidden space-y-4">
        @forelse ($taxBrackets as $taxBracket)
            <div class="rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-900">
                ...
                <div class="grid grid-cols-2 gap-3 text-sm border-t border-zinc-200 dark:border-zinc-700 pt-3">
                    <div>
                ...
                <div class="mt-4 flex gap-2 pt-3 border-t border-zinc-200 dark:border-zinc-700">
        ...
        @empty
            <div class="rounded-lg border border-zinc-200 bg-white p-8 text-center dark:border-zinc-700 dark:bg-zinc-900">
                <i class="fas fa-calculator text-4xl text-zinc-300 dark:text-zinc-600 mb-3"></i>
