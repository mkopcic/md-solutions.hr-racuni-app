        ...
        <div class="grid auto-rows-min gap-4 md:grid-cols-3">
            <div class="overflow-hidden rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-900">
                ...
                <div class="mt-1 flex items-center text-sm">
                    <a href="{{ route('invoices.index') }}" class="text-blue-500 hover:underline inline-flex items-center gap-1" wire:navigate>
            ...
            <div class="overflow-hidden rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-900">
                ...
                <div class="mt-1 flex items-center text-sm">
                    <a href="{{ route('customers.index') }}" class="text-blue-500 hover:underline inline-flex items-center gap-1" wire:navigate>
            ...
            <div class="overflow-hidden rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-900">
                ...
                <div class="mt-1 flex items-center text-sm">
                    <a href="{{ route('kpr.index') }}" class="text-blue-500 hover:underline inline-flex items-center gap-1" wire:navigate>
        ...
        <div class="rounded-xl border border-zinc-200 bg-white dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <div class="divide-y divide-zinc-200 dark:divide-zinc-700">
                @forelse(\App\Models\Invoice::with('customer')->latest()->take(5)->get() as $invoice)
                    <div class="flex items-center justify-between px-6 py-4">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('invoices.show', $invoice) }}" class="rounded-lg bg-zinc-100 px-3 py-1 text-sm font-medium text-zinc-900 hover:bg-zinc-200 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:bg-zinc-700 inline-flex items-center gap-1" wire:navigate>
                ...
                @empty
                    <div class="p-6 text-center text-zinc-500">
                        ...
                        <a href="{{ route('invoices.create') }}" class="ml-2 text-blue-500 hover:underline inline-flex items-center gap-1" wire:navigate>
            ...
            @if(\App\Models\Invoice::count() > 5)
                <div class="border-t border-zinc-200 px-6 py-3 text-right dark:border-zinc-700">
                    <a href="{{ route('invoices.index') }}" class="text-sm text-blue-500 hover:underline inline-flex items-center gap-1" wire:navigate>
                        <i class="fas fa-list"></i>
                        Prikaži sve račune
                    </a>
                </div>
        ...
        <div class="flex gap-4">
            <div class="w-1/2 rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-900">
                ...
                <div class="grid gap-2">
                    ...
                    <a href="{{ route('customers.index') }}?create=1" class="flex w-full items-center gap-2 rounded-lg border border-zinc-300 bg-white px-4 py-2 text-center text-sm font-medium text-zinc-800 hover:bg-zinc-100 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-700" wire:navigate>
