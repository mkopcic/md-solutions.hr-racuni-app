...
<body>
    <div class="header">
        <h1>📋 {{ $business->name }}</h1>
        <p style="margin: 0;">Ponuda #{{ $quote->full_quote_number }}</p>
    </div>

    <div class="content">
        <p>Poštovani,</p>

        <p>U prilogu se nalazi ponuda za kupca <strong>{{ $customerName }}</strong>.</p>

        <div class="quote-details">
            <table>
                <tr>
                    <td>Broj ponude:</td>
                    <td><strong>{{ $quote->full_quote_number }}</strong></td>
                </tr>
                <tr>
        ...
        <p>PDF ponuda se nalazi u prilogu ovog emaila.</p>
