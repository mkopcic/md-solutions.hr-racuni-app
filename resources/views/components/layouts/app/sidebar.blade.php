...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Aplikacija')" class="grid">
                ...
                <flux:navlist.item icon="wrench-screwdriver" :href="route('services.index')"
                    :current="request()->routeIs('services.*')" wire:navigate>{{ __('Usluge') }}</flux:navlist.item>
                <flux:navlist.item icon="book-open" :href="route('kpr.index')" :current="request()->routeIs('kpr.*')"
            ...
            <flux:navlist.group :heading="__('Postavke')" class="grid">
                ...
                <flux:navlist.item icon="calculator" :href="route('tax-brackets.index')"
                    :current="request()->routeIs('tax-brackets.*')" wire:navigate>{{ __('Porezni razredi') }}
                </flux:navlist.item>
            </flux:navlist.group>
