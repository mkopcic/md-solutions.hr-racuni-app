...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', default: 'Izrada računa za obrt i tvrtku'),
    ...
    */
    ...
    'locale' => env('APP_LOCALE', default: 'hr'),

    'fallback_locale' => env('APP_FALLBACK_LOCALE', default: 'hr'),

    'faker_locale' => env('APP_FAKER_LOCALE', default: 'hr_HR'),
